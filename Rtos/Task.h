...
class TaskBase {
    private:
        static constexpr uint32_t CDC_MSK {0x7F};
...
class Task final : public TaskBase {
        ...
        void init_stack() {
            ...
            *this->top_of_stack = lower_csa;
            ...
            constexpr uint32_t PCXI_PIE {1uL << 21}; /* Previous Interrupt Enable */
            constexpr uint32_t PCXI_UL {1uL << 20}; /* Upper Context Tag */
            constexpr uint32_t INITIAL_LOWER_PCXI {PCXI_PIE | PCXI_UL};
